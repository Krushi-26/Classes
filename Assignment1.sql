...
-- actor_id is the common column 
SELECT * FROM actor a
JOIN film_actor fa
ON a.actor_id = fa.actor_id;
-- one row per actor film 
...
-- we use left join as we need all customers even with zero rentals
-- Count rentals per customer ,Each row in rental = one rental
-- add names and ordering 
